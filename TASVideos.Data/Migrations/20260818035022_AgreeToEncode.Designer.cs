...
namespace TASVideos.Data.Migrations
{
    ...
    [Migration("20260818035022_AgreeToEncode")]
    partial class AgreeToEncode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Submission", b =>
                {
                    ...
                    b.Property<bool>("AuthorizedForEncode")
                        .HasColumnType("boolean")
                        .HasColumnName("authorized_for_encode");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.User", b =>
                {
                    ...
                    b.Property<bool>("PreselectMinorEditOnPostEdits")
                        .HasColumnType("boolean")
                        .HasColumnName("preselect_minor_edit_on_post_edits");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.RoleClaim", b =>
                {
                    b.HasOne("TASVideos.Data.Entity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.UserClaim", b =>
                {
                    b.HasOne("TASVideos.Data.Entity.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
